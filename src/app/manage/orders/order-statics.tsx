...
import { GetOrdersResType } from '@/app/schemaValidations/order.schema';
...
export default function OrderStatics({
  ...
  dataOrder: GetOrdersResType['data'];
}) {
  ...
  return (
    <Fragment>
      ...
      <div className="flex justify-between items-center gap-4 flex-wrap py-4">
        ...
        <Badge className="p-2 shadow-md rounded-md font-semibold text-lg">
          Doanh thu : {formatCurrency(toatalRevenue)}
        </Badge>
      </div>
    </Fragment>
  );
